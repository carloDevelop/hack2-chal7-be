...
const createRegistration = async (data) => {
  ...
  event_abilities.forEach(abilityevent_id => {
    ...
    db.run("INSERT INTO AbilityRegistration (abilityregistration_id, registration_id, abilityevent_id) VALUES (?, ?, ?)", abilityregistration_id, id, abilityevent_id)
  ...
  db.close();
  return { id, ...evdata, abilities_registrations: abilitiesRegistrations };
}
